const mockLocations = [
  ...
  },
  {
    ...
    connections: [
      ...
      { to: "Radiology", distance: 18, direction: "Walk through the reception corridor towards Radiology." },
    ],
  },
  {
    _id: "Radiology",
    name: "Radiology",
    floor: 1,
    landmark: "Radiology Department",
    description: "Radiology imaging and diagnostic services.",
    connections: [
      { to: "Reception", distance: 18, direction: "Head back to Reception through the corridor." },
    ],
  },
  {
    _id: "Pharmacy",
    ...
    connections: [
      { to: "Pediatric", distance: 12, direction: "Move forward from Pharmacy, Pass through  Pediatric will be ahead." },
